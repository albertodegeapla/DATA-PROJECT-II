...
# ejemplo de correrlo python .\recogida_pasajero.py --project_id skilled-seeker-411714 --person_topic_sub data_projectII_person-sub --car_topic_sub data_projectII_car-sub --dataset_id edem_tabla --car_table coche --person_table persona
...
class ProcessData(beam.DoFn):
    def process(self, element):
        ...
        distancia_rangos = {'antipático': 50000, 'normal': 75000, 'majo': 100000}
            ...
            if distancia <= rango:
                ...
                if destinos_distancia <= 500:
                    ...
                    if datos_pasajero['cartera'] >= datos_coche['precio']:
                        ...
                        datos_coche['cartera'] += datos_coche['precio']
...
def run_local():
    ...
    with beam.Pipeline(options=pipeline_options) as p:
        ...
        datos_pasajero = (p | "Read Passenger Data" >> beam.io.ReadFromPubSub(subscription=f'projects/{project_id}/subscriptions/{topic_person}') 
                            | "decode passenger message" >> beam.Map(lambda x: json.loads(x)) 
                            | "print pasajero" >> beam.Map(print)
                            )
